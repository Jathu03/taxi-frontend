...
const mockUsers: CorporateUser[] = [
    { id: "1", name: "John Doe", email: "john@pgie.com", phone: "0771112222", corporate: "PGIE", status: "Active", dateModified: "2/26/2024 8:23:59 PM" },
    { id: "2", name: "Jane Smith", email: "jane@inbay.com", phone: "0773334444", corporate: "Inbay", status: "Active", dateModified: "2/26/2024 8:23:59 PM" },
];
...
const columns = (
    navigate: ReturnType<typeof useNavigate>
        ...
        { accessorKey: "corporate", header: () => <span className="font-bold text-black">Corporate</span> },
        { accessorKey: "status", header: () => <span className="font-bold text-black">Status</span> },
...
export default function ManageCorporateUsers() {
    ...
    const filteredData = useMemo(() => {
        return data.filter((item) => {
            ...
            const value = item[filterBy as keyof CorporateUser]?.toString().toLowerCase() || "";
    ...
    return (
        <div className="p-6 space-y-6 bg-gradient-to-br from-white via-purple-50/30 to-blue-50/30 min-h-screen">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-bold text-[#6330B8]">Corporate User Management</h1>
                    <p className="text-muted-foreground mt-1">Manage users belonging to corporate organizations</p>
                </div>
                <Button
                    onClick={() => navigate("/admin/corporate-users/add")}
