...
const mockManufacturers: Manufacturer[] = [
  { id: "1", name: "Honda", code: "HONDA", dateModified: "2/26/2024 8:23:59 PM" },
  { id: "2", name: "Toyota", code: "TOYOTA", dateModified: "2/26/2024 8:23:59 PM" },
];
...
export default function ManageManufacturers() {
  ...
  const {
    data,
    handleBulkDelete,
  } = useDataTable<Manufacturer>({
    initialData: mockManufacturers,
  });
