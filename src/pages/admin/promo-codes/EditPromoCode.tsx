...
export default function EditPromoCode() {
  ...
  useEffect(() => {
    ...
    const mockPromoCodes: Record<string, typeof formData> = {
      "1": {
        code: "Ride1",
        description: "Offer",
        ...
        discountIn: "Percentage",
        discountValue: "30",
        startDate: "2018-06-05T05:34",
        endDate: "2018-07-31T05:34",
        isActive: false,
        maxAmount: "150.00",
        isFirstTimeOnly: false,
        maxCountPerUser: "20",
      ...
      "2": {
        ...
        discountIn: "Percentage",
        discountValue: "10",
        startDate: "2018-06-04T12:02",
        endDate: "2018-06-07T12:02",
        isActive: false,
        maxAmount: "500.00",
        isFirstTimeOnly: false,
        maxCountPerUser: "15",
      ...
      "3": {
        ...
        discountIn: "Amount",
        discountValue: "100",
        startDate: "2018-05-28T01:13",
        endDate: "2018-06-01T01:13",
        isActive: false,
        maxAmount: "0.00",
        isFirstTimeOnly: false,
        maxCountPerUser: "5",
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: `Promo code "${formData.code}" has been updated.`,
    });
