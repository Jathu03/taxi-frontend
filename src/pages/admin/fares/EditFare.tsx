...
export default function EditFare() {
  ...
  const [formData, setFormData] = useState({
    fareCode: "STANDARD",
    minimumDistance: "1.00",
    minimumRate: "0.00",
    ratePerKm: "0.00",
    freeWaitTime: "0",
    waitingChargePerMin: "0.00",
    peakHourStartTime: "",
    peakHourEndTime: "",
    offPeakMinRateHike: "0.00",
    ratePerKmHike: "0.00",
    onTheMeter: false,
    minimumTime: "0",
    additionalTimeSlot: "0",
    ratePerAdditionalTimeSlot: "0.00",
    isPackage: false,
  });
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({
      title: "Success",
      description: "Fare scheme has been updated successfully.",
    });
