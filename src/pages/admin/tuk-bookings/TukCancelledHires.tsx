...
const mockTukCancelledHires: TukCancelledHire[] = [
  {
    id: "1",
    bookingId: "295747",
    org: "BCD Travels",
...
export default function TukCancelledHires() {
  ...
  const columns = (): ColumnDef<TukCancelledHire>[] => [
      ...
      cell: ({ row }) => {
        return (
          <Button
            ...
            onClick={() => navigate(`/admin/tuk/view/${row.original.bookingId}`)}
          >
            View Hire
          </Button>
        );
  ...
  const {
    ...
    initialData: mockTukCancelledHires,
  });
