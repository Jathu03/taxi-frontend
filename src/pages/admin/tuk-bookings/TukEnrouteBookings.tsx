...
const mockTukEnroute: TukEnrouteBooking[] = [
  { id: "1", bookingId: "TUK-ENR-001", customerName: "Sarah Johnson", driverName: "Sunil Perera", vehicleNumber: "WP-TUK-1234", pickupLocation: "Colombo 03", estimatedArrival: "3 mins", status: "En Route" },
];
...
export default function TukEnrouteBookings() {
  ...
  const {
    ...
    initialData: mockTukEnroute,
  });

  const filteredData = useMemo(() => {
    return data.filter((booking) => {
      if (!filterText) return true;
      const value = booking[filterBy as keyof TukEnrouteBooking]?.toString().toLowerCase() || "";
  ...
  return (
    <div className="p-6 space-y-6 bg-gradient-to-br from-white via-purple-50/30 to-blue-50/30 min-h-screen">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-[#6330B8]">TUK En Route</h1>
          <p className="text-muted-foreground mt-1">TUK drivers on their way to pickup</p>
        </div>
