...
export default function AddCorporate() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log("Creating corporate:", formData);
  ...
  return (
    <div className="p-6 space-y-6 bg-gradient-to-br from-white via-purple-50/30 to-blue-50/30 min-h-screen">
      <div>
        <h1 className="text-3xl font-bold text-[#6330B8]">Add New Corporate Client</h1>
        <p className="text-muted-foreground mt-1">Create a new corporate client account</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Enter the corporate client's basic details</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Enter contact details for the corporate client</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Configure discount rates and booking settings</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
