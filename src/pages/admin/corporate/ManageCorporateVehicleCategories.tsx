...
): ColumnDef<CorporateVehicleCategory>[] => [
...
const mockCategories: CorporateVehicleCategory[] = [
  { id: "1", categoryName: "Economy", description: "Standard business travel" },
  { id: "2", categoryName: "Executive", description: "Premium travel for executives" },
  { id: "3", categoryName: "Group", description: "Vans and buses for group transport" },
];
...
export default function ManageCorporateVehicleCategories() {
  ...
  const {
    data,
    handleBulkDelete,
  } = useDataTable<CorporateVehicleCategory>({
  ...
  const filteredData = useMemo(() => {
    return data.filter((cat) => {
      ...
      return cat.categoryName.toLowerCase().includes(filterText.toLowerCase());
    });
  }, [data, filterText]);
  ...
  return (
    <div className="p-6 space-y-6 bg-gradient-to-br from-white via-purple-50/30 to-blue-50/30 min-h-screen">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => navigate("/admin/corporate/vehicle-categories/add")} className="bg-[#6330B8]">
