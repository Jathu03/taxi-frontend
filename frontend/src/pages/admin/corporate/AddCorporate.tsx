...
export default function AddCorporate() {
  ...
  const buildRequestPayload = (): CreateCorporateRequest => {
    ...
    // FIXED: Cast to the specific Enum strings the backend expects
    if (formData.billingType) {
      payload.billingType = formData.billingType as "DAILY" | "MONTHLY" | "PREPAID";
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await corporateService.createCorporate(payload);

      toast({
        title: "Success",
        description: `Corporate client "${response.name}" created successfully.`,
      });
    ...
    <div className="p-6 space-y-6 bg-gradient-to-br from-white via-purple-50/30 to-blue-50/30 min-h-screen">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Create a new corporate client account
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Enter the corporate client's basic details
            </CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Enter contact details for the corporate client
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Configure billing type, limits, and system behavior
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent>
                    {/* FIXED: Enum values matching Java Backend */}
        ...
        <div className="flex gap-4">
          <Button
            ...
            disabled={isSubmitting}
          >
            {isSubmitting ? "Creating..." : "Create Corporate Client"}
          </Button>
          <Button
            type="button"
            variant="outline"
